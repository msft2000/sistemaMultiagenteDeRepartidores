...
public final class PythonScripts {
    ...
    public String[] getEnlaces(String idNodo,char input_output){
        ...
        Process mProcess;         
        try{
            mProcess = Runtime.getRuntime().exec(new String[]{"python","resources/scripts/SumoEdges.py",idNodo,"resources/SumoMaps/Red2Way2.net.xml",input_output+""},null,new File("."));
