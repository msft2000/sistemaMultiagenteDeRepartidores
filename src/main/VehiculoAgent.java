...
public class VehiculoAgent extends Agent{
    ...
    protected void setup() {
        ...
        origen=(Nodo)args[0];
        destino=(Nodo)args[1];
        viajes=Integer.parseInt((String) args[2]);
        ...
        TickerBehaviour b=new TickerBehaviour(this, 1200) {
            ...
            protected void onTick() {
                ...
                if(v.contains(id)){
                    int numViajesRestantes=origen.getValueViaje(destino);
                    int val = ((numViajesRestantes<=viajes) ? 0 : numViajesRestantes-viajes);
                    origen.setViajesVehiculos(destino,val);
                    doDelete();
                } 
                else{
